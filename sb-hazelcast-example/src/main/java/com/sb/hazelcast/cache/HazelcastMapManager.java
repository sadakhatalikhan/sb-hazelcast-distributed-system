...
import com.sb.hazelcast.constants.ApplicationConstants;
...
public class HazelcastMapManager implements InitializingBean {
    ...
    private IMap<String,UserAccount> hazelcastMap;
    ...
    public void putToMap(String key, UserAccount value){
    ...
    public UserAccount getMapItemWithKey(String key){
    ...
    public Map<String, UserAccount> getAllMap(){
